 ...
 */
public class GameAch_Block16Get extends HasBlockAchievement {

    public GameAch_Block16Get(boolean isAchieved) {
        super(AchievementNames.BLOCK16_GET, isAchieved, AchievementDetails.BLOCK16_GET, 16);
    }
